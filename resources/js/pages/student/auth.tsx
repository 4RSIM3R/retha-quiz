...
export default function StudentAuth() {
    ...
    const submit = (e: { preventDefault: () => void }) => {
        e.preventDefault();
        post(route('auth-student.attempt'), {
            onSuccess: (_) => {
            ...
            <div className='lg:p-8'>
                <form onSubmit={submit} className='mx-auto flex w-full flex-col justify-center sm:max-w-md'>
                    <div className='flex flex-col space-y-2 text-left mb-4'>
                        <h1 className='text-2xl font-semibold tracking-tight'>Student Auth</h1>
...
StudentAuth.layout = (page: any) => <GuestLayout children={page} />;
